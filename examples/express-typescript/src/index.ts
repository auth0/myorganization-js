...
import { MyOrganization, MyOrganizationError, MyOrganizationTimeoutError } from "@auth0/myorganization-js/server";
 ...
 */
app.get(
    "/api/organization/configuration/identity-providers",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
 ...
 */
app.get(
    "/api/domains/:domainId/identity-providers",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { domainId } = req.params;
 ...
 */
app.post(
    "/api/identity-providers/:idpId/refresh-attributes",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
 ...
 */
app.post(
    "/api/identity-providers/:idpId/detach",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
 ...
 */
app.post(
    "/api/identity-providers/:idpId/domains",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
        const { domain } = req.body;
 ...
 */
app.delete(
    "/api/identity-providers/:idpId/domains/:domain",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
 ...
 */
app.get(
    "/api/identity-providers/:idpId/provisioning",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
 ...
 */
app.post(
    "/api/identity-providers/:idpId/provisioning/refresh-attributes",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
 ...
 */
app.get(
    "/api/identity-providers/:idpId/provisioning/scim-tokens",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        const { idpId } = req.params;
 ...
 */
app.delete(
    "/api/identity-providers/:idpId/provisioning/scim-tokens/:tokenId",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
        ...
        try {
            ...
            res.json({
                ...
                nextSteps: [
                    ...
                    domain
                        ? `Users with email addresses @${domain} will be automatically redirected to this SSO provider`
                        : "Configure Home Realm Discovery by adding a domain",
 ...
 */
app.post(
    "/api/workflows/setup-provisioning",
    asyncHandler(async (req: Request, res: Response) => {
        const client = getMyOrgClient();
