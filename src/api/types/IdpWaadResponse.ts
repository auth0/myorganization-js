 ...
 */
export interface IdpWaadResponse {
    strategy: IdpWaadResponse.Strategy;
    /** Identity provider specific options. */
    options?: MyOrganization.IdpWaadOptionsResponse | undefined;
...
export namespace IdpWaadResponse {
