 ...
 */
export interface IdpPingFederateRequest {
    strategy: IdpPingFederateRequest.Strategy;
    /** Identity provider specific options. */
    options: MyOrganization.IdpPingFederateOptionsRequest;
...
export namespace IdpPingFederateRequest {
