 ...
 */
export interface IdpAdfsResponse {
    strategy: IdpAdfsResponse.Strategy;
    /** Identity provider specific options. */
    options?: MyOrganization.IdpAdfsOptionsResponse | undefined;
...
export namespace IdpAdfsResponse {
