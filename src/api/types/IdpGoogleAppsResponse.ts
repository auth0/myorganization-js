 ...
 */
export interface IdpGoogleAppsResponse {
    strategy: IdpGoogleAppsResponse.Strategy;
    /** Identity provider specific options. */
    options?: MyOrganization.IdpGoogleAppsOptionsResponse | undefined;
...
export namespace IdpGoogleAppsResponse {
