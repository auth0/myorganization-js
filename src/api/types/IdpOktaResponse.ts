 ...
 */
export interface IdpOktaResponse {
    strategy: IdpOktaResponse.Strategy;
    /** Identity provider specific options. */
    options?: MyOrganization.IdpOktaOptionsResponse | undefined;
...
export namespace IdpOktaResponse {
