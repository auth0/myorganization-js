...
export class RolesClient {
     ...
     *
     * @param {MyOrganization.ListRolesRequestParameters} request
    ...
    public async list(
    ...
    ): Promise<core.Page<MyOrganization.Role, MyOrganization.ListRolesResponseContent>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: MyOrganization.ListRolesRequestParameters,
            ): Promise<core.WithRawResponse<MyOrganization.ListRolesResponseContent>> => {
                ...
                const { from: from_, take = 50, name } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as MyOrganization.ListRolesResponseContent,
        ...
        return new core.Page<MyOrganization.Role, MyOrganization.ListRolesResponseContent>({
