...
export class VerifyClient {
    ...
    public create(
        ...
        return core.HttpResponsePromise.fromPromise(this.__create(domain_id, requestOptions));
    }
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `domains/${core.url.encodePathParam(domain_id)}/verify`,
            ),
            method: "POST",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/domains/{domain_id}/verify");
    }
}
