...
export class IdentityProvidersClient {
    ...
    public updateAttributes(
        ...
        return core.HttpResponsePromise.fromPromise(this.__updateAttributes(idp_id, request, requestOptions));
    }
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MyOrganizationEnvironment.Default,
                `identity-providers/${core.url.encodePathParam(idp_id)}/update-attributes`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
