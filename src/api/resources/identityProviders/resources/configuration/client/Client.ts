...
export class Configuration {
    ...
    ): core.HttpResponsePromise<Auth0MyOrg.GetIdpConfigurationResponseContent> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: Configuration.RequestOptions,
    ): Promise<core.WithRawResponse<Auth0MyOrg.GetIdpConfigurationResponseContent>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Auth0MyOrg.GetIdpConfigurationResponseContent,
